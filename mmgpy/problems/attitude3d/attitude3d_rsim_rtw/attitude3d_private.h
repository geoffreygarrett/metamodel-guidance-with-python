...
extern void attitude3d_MovingMaximum_Init(DW_MovingMaximum_attitude3d_T *localDW);
extern void attitude3d_MovingMaximum_Start(DW_MovingMaximum_attitude3d_T
  *localDW);
extern void attitude3d_MovingMaximum(real_T rtu_0, B_MovingMaximum_attitude3d_T *
  localB, DW_MovingMaximum_attitude3d_T *localDW);
extern void attitude3d_MovingMinimum_Term(DW_MovingMinimum_attitude3d_T *localDW);
extern void attitude3d_MovingMaximum_Term(DW_MovingMaximum_attitude3d_T *localDW);
