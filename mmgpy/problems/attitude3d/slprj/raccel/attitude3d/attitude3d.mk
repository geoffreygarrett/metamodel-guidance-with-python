...
MODEL                  = attitude3d
MODULES                = rt_logging.c attitude3d.c attitude3d_capi.c attitude3d_data.c attitude3d_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
MAKEFILE               = attitude3d.mk
MATLAB_ROOT            = /usr/local/MATLAB/R2019b
ALT_MATLAB_ROOT        = /usr/local/MATLAB/R2019b
MATLAB_ROOTQ           = \"/usr/local/MATLAB/R2019b\"
MASTER_ANCHOR_DIR      = 
START_DIR              = /home/ggarrett/lab/test/attitude_problem_3D/version2
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/attitude3d \
