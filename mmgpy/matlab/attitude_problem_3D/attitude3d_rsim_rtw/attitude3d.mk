...
MODEL                  = attitude3d
MODULES                = rt_logging.c attitude3d.c attitude3d_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rsim_main.c rsim_sup.c rsim_mat.c simulink_solver_api.c rsim_utils.c common_utils.c rt_sim.c
PRODUCT                = $(RELATIVE_PATH_TO_ANCHOR)/attitude3d
MAKEFILE               = attitude3d.mk
MATLAB_ROOT            = /usr/local/MATLAB/R2019b
ALT_MATLAB_ROOT        = /usr/local/MATLAB/R2019b
START_DIR              = /home/ggarrett/lab/metamodel-guidance-with-python/mmgpy/matlab/attitude_problem_3D
S_FUNCTIONS_LIB        = 
COMPUTER               = GLNXA64
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/attitude3d_rsim_rtw \
