...
MODEL                  = rs_bicycle2
MODULES                = rt_logging.c rs_bicycle2.c rs_bicycle2_capi.c rs_bicycle2_data.c rs_bicycle2_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
MAKEFILE               = rs_bicycle2.mk
MATLAB_ROOT            = /usr/local/MATLAB/R2019b
ALT_MATLAB_ROOT        = /usr/local/MATLAB/R2019b
MATLAB_ROOTQ           = \"/usr/local/MATLAB/R2019b\"
MASTER_ANCHOR_DIR      = 
START_DIR              = /home/ggarrett/lab/metamodel-guidance-with-python/mmgpy/matlab/rs_bicycle
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/rs_bicycle2 \
