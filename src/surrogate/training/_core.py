...
class Trainer:
    def __init__(self, PATH, dataset, model=None, optimizer=None, criterion=None, preprocessing=None, batch_size=200, num_epochs=150, learning_rate=1e-2):
        self._path = PATH
    ...
    def _train(self):
        ...
        for epoch in range(self._epoch, self._num_epochs):
            ...
            print(f'Epoch [{self._epoch+1:^5}/{self._num_epochs:^5}]  |  Train Loss: {train_loss_item: 8.6f}  |  Test Loss: {test_loss_item: 8.6f}  |  lr: {learning_rate: 6.5f}')  
