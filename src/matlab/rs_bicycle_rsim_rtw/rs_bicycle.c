 ...
 * C source code generated on : Wed Oct 30 01:29:57 2019
 *
 ...
 *    synthesized block
 */
void rs_bicycle_MovingMaximum1_Init(DW_MovingMaximum1_rs_bicycle_T *localDW)
{
  dsp_MovingMaximum_rs_bicycle_T *obj;
  e_dsp_private_SlidingWindowMa_T *obj_0;
  int32_T i;

  /* InitializeConditions for MATLABSystem: '<Root>/Moving Maximum1' */
  obj = &localDW->obj;
  obj_0 = obj->pStat;
  ...
  /* End of InitializeConditions for MATLABSystem: '<Root>/Moving Maximum1' */
}
 ...
 *    synthesized block
 */
void rs_bicycle_MovingMaximum1_Start(DW_MovingMaximum1_rs_bicycle_T *localDW)
{
  e_dsp_private_SlidingWindowMa_T *iobj_0;
  dsp_MovingMaximum_rs_bicycle_T *b_obj;
  dsp_MovingMaximum_rs_bicycle_T *obj;

  /* Start for MATLABSystem: '<Root>/Moving Maximum1' */
 ...
 *    synthesized block
 */
void rs_bicycle_MovingMaximum1(real_T rtu_0, B_MovingMaximum1_rs_bicycle_T
  *localB, DW_MovingMaximum1_rs_bicycle_T *localDW)
{
  dsp_MovingMaximum_rs_bicycle_T *obj;
  e_dsp_private_SlidingWindowMa_T *obj_0;
  e_dsp_private_SlidingWindowMa_T *obj_1;
  ...
  /* MATLABSystem: '<Root>/Moving Maximum1' */
  obj = &localDW->obj;
  obj_0 = obj->pStat;
  if (obj_0->isInitialized != 1) {
    obj_1 = obj_0;
  ...
  obj_0->pCount = cnt;
  obj_0->pTop = top;
  localB->MovingMaximum1 = y;

  /* End of MATLABSystem: '<Root>/Moving Maximum1' */
}
 ...
 *    synthesized block
 */
void rs_bicycle_MovingMaximum1_Term(DW_MovingMaximum1_rs_bicycle_T *localDW)
{
  /* Terminate for MATLABSystem: '<Root>/Moving Maximum1' */
...
void MdlInitialize(void)
{
  ...
  rs_bicycle_MovingMaximum1_Init(&rtDW.MovingMaximum);
  rs_bicycle_MovingMaximum1_Init(&rtDW.MovingMaximum2);
  rs_bicycle_MovingMaximum1_Init(&rtDW.MovingMaximum1);
}
...
void MdlStart(void)
{
  ...
  rs_bicycle_MovingMaximum1_Start(&rtDW.MovingMaximum);
  rs_bicycle_MovingMaximum1_Start(&rtDW.MovingMaximum2);
  rs_bicycle_MovingMaximum1_Start(&rtDW.MovingMaximum1);
  MdlInitialize();
}
...
void MdlOutputs(int_T tid)
{
  ...
  rs_bicycle_MovingMaximum1(rtB.stopping_dist, &rtB.MovingMaximum,
    &rtDW.MovingMaximum);
  if (ssIsSampleHit(rtS, 1, 0)) {
    /* UnitDelay: '<S2>/UD' */
  ...
  rs_bicycle_MovingMaximum1(rtB.Switch_h, &rtB.MovingMaximum2,
    &rtDW.MovingMaximum2);
  if (ssIsSampleHit(rtS, 1, 0)) {
  ...
  rs_bicycle_MovingMaximum1(rtB.slipping, &rtB.MovingMaximum1,
    &rtDW.MovingMaximum1);

  /* Outport: '<Root>/out' incorporates:
   *  Inport: '<Root>/Time-Velocity Array'
   */
  rtY.out[0] = rtB.frac_dist;
  rtY.out[1] = rtB.Switch;
  rtY.out[2] = rtB.MovingMinimum1;
  rtY.out[3] = rtB.MovingMaximum.MovingMaximum1;
  rtY.out[4] = rtB.MovingMaximum2.MovingMaximum1;
  rtY.out[5] = rtB.MovingMaximum1.MovingMaximum1;
  rtY.out[6] = rtU.vel;
  if (ssIsSampleHit(rtS, 1, 0)) {
  }
...
void MdlTerminate(void)
{
  ...
  rs_bicycle_MovingMaximum1_Term(&rtDW.MovingMaximum);
  rs_bicycle_MovingMaximum1_Term(&rtDW.MovingMaximum2);
  rs_bicycle_MovingMaximum1_Term(&rtDW.MovingMaximum1);
}
...
void MdlInitializeSizes(void)
{
  ...
  ssSetNumBlocks(rtS, 96);             /* Number of blocks */
  ssSetNumBlockIO(rtS, 61);            /* Number of block outputs */
...
SimStruct * rs_bicycle(void)
{
  ...
  ssSetStepSize(rtS, 2.0);
  ssSetFixedStepSize(rtS, 2.0);
  ...
  /* Setup for data logging */
  {
    ...
    rtliSetLogY(ssGetRTWLogInfo(rtS), "f");
  }
  ...
  ssSetChecksumVal(rtS, 0, 344515244U);
  ssSetChecksumVal(rtS, 1, 3557237965U);
  ssSetChecksumVal(rtS, 2, 3150759334U);
  ssSetChecksumVal(rtS, 3, 2717449777U);
  return rtS;
}
