...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&rtB.init_position), 0, 0, 54 },

  { (char_T *)(&rtB.RelationalOperator[0]), 8, 0, 18 },

  { (char_T *)(&rtB.MovingMaximum.MovingMaximum1), 0, 0, 1 },

  { (char_T *)(&rtB.MovingMaximum2.MovingMaximum1), 0, 0, 1 },

  { (char_T *)(&rtB.MovingMaximum1.MovingMaximum1), 0, 0, 1 }
  ,
  ...
  { (char_T *)(&rtDW.AuxilliaryScope_PWORK.LoggedData[0]), 11, 0, 22 },
...
static DataTypeTransition rtPTransitions[] = {
  { (char_T *)(&rtP.env_forest[0]), 0, 0, 34 }
};
