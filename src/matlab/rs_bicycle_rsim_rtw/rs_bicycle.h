...
#define NBLOCKIO                       (61)                      /* Number of data output port signals */
...
/* Block signals for system '<Root>/Moving Maximum1' */
typedef struct {
  real_T MovingMaximum1;               /* '<Root>/Moving Maximum1' */
} B_MovingMaximum1_rs_bicycle_T;

/* Block states (default storage) for system '<Root>/Moving Maximum1' */
typedef struct {
  e_dsp_private_SlidingWindowMa_T gobj_0;/* '<Root>/Moving Maximum1' */
  e_dsp_private_SlidingWindowMa_T gobj_1;/* '<Root>/Moving Maximum1' */
  dsp_MovingMaximum_rs_bicycle_T obj;  /* '<Root>/Moving Maximum1' */
  boolean_T objisempty;                /* '<Root>/Moving Maximum1' */
} DW_MovingMaximum1_rs_bicycle_T;
...
typedef struct {
  ...
  real_T MovingMinimum1;               /* '<Root>/Moving Minimum1' */
  ...
  boolean_T RelationalOperator_h;      /* '<S16>/Relational Operator' */
  boolean_T RelationalOperator1_d;     /* '<S16>/Relational Operator1' */
  boolean_T LogicalOperator_k;         /* '<S16>/Logical Operator' */
  B_MovingMaximum1_rs_bicycle_T MovingMaximum;/* '<Root>/Moving Maximum1' */
  B_MovingMaximum1_rs_bicycle_T MovingMaximum2;/* '<Root>/Moving Maximum1' */
  B_MovingMaximum1_rs_bicycle_T MovingMaximum1;/* '<Root>/Moving Maximum1' */
} B;
...
typedef struct {
  ...
  DW_MovingMaximum1_rs_bicycle_T MovingMaximum;/* '<Root>/Moving Maximum1' */
  DW_MovingMaximum1_rs_bicycle_T MovingMaximum2;/* '<Root>/Moving Maximum1' */
  DW_MovingMaximum1_rs_bicycle_T MovingMaximum1;/* '<Root>/Moving Maximum1' */
} DW;
...
typedef struct {
  real_T vel;                          /* '<Root>/Time-Velocity Array' */
} ExtU;

/* External outputs (root outports fed by signals with default storage) */
typedef struct {
  real_T out[7];                       /* '<Root>/out' */
} ExtY;
 ...
 * '<S16>'  : 'rs_bicycle/aux2: Fraction Spent In Forest/In Forest Boolearn'
 * '<S17>'  : 'rs_bicycle/aux3: Closest Instantaenous Traffic/Minimum Between Signals '
 */
