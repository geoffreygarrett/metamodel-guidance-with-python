...
MODEL                  = rtwdemo_rsim_i
MODULES                = rt_logging.c rtwdemo_rsim_i.c rsim_main.c rsim_sup.c rsim_mat.c simulink_solver_api.c rsim_utils.c common_utils.c
PRODUCT                = $(RELATIVE_PATH_TO_ANCHOR)/rtwdemo_rsim_i
MAKEFILE               = rtwdemo_rsim_i.mk
MATLAB_ROOT            = /usr/local/MATLAB/R2019b
ALT_MATLAB_ROOT        = /usr/local/MATLAB/R2019b
START_DIR              = /home/ggarrett/lab/NB10422645/src/matlab
S_FUNCTIONS_LIB        = $(START_DIR)/slprj/rsim/_sharedutils/rtwshared.a
COMPUTER               = GLNXA64
...
DEFINES_CUSTOM        = 
TARGET_LANG_EXT       = c
SYSTEM_LIBS           = -L"/usr/local/MATLAB/R2019b/bin/glnxa64" -lmat -lmx -lut -lmwsl_fileio -lmwsl_simtarget_instrumentation -lmwi18n -lmwsigstream -lmwsl_AsyncioQueue -lmwsf_runtime -lmwsl_solver_rtw
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/rtwdemo_rsim_i_rsim_rtw \
	...
	-I$(START_DIR)/slprj/rsim/_sharedutils \
