...
class HyperParamRoutineOptimizer:
    ...
    * `optimizer__optimizer_name`
    ...
    def __init__(self, routines=None, **kwargs):
        ...
        #
        self._optimizer_map = None
        self._space_map = None

    @staticmethod
    def optimizer_map(optimizer_name):
        """
    ...
    def optimize(self, function, tdmq=False):
        """
    ...
    def reset(self, routines=None,
        ...
        # Reset default params if desired.
        if reset_default:
...
if __name__ == "__main__":
    ...
    routine = {
        "intermediate": [
            ...
            },
            {
                ...
                "real__gamma": (1e-3, 1e3),
                "real__epsilon": (1e-2, 1e-1),
                "real__n_hidden_layers": (1e-2, 1e-1),
    ...
    result1 = test.optimize(function_to_minimize)
    result2 = test.optimize(function_to_minimize)
